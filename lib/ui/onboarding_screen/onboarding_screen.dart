  ...
  Widget build(BuildContext context) {
    ...
    return  Scaffold(
      body: OnBoardingSlider(
        ...
        speed: 1.2,
        background: [
          Image.asset(BaseAssets.onboardingImage,width: size.width,),
          Image.asset(BaseAssets.onboardingImage,width: size.width,),
          Image.asset(BaseAssets.onboardingImage,width: size.width,),
        ],
        onFinish: (){
        ...
        skipTextButton: const Text('Skip',style: TextStyle(color: BaseColors.blackColor),),
        pageBodies: [
          onBoardingWidget(BaseStrings.onboardingText1),
          onBoardingWidget(BaseStrings.onboardingText2),
          onBoardingWidget(isLast: true,BaseStrings.onboardingText3,),
        ],),
  ...
  Widget onBoardingWidget(String descriptionText,{bool isLast = false}){
    return   Container(
      ...
      child:  Column(
        ...
        children: <Widget>[
          isLast? const SizedBox.shrink():  Text(descriptionText,textAlign: TextAlign.center,),
        ],
      ),
    );
  }
